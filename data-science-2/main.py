...
def q1():
    stat, p = sct.shapiro(get_sample(athletes, 'height'))
    return(bool(p <= 0.05))
q1()
...
def q2():
    ...
    stats, p_value = sct.jarque_bera(get_sample(athletes, 'height'))
...
def q3():
    ...
    stats, p_value = sct.normaltest(get_sample(athletes, 'height'))
    return(bool(p_value<=0.05))
q3()
...
def q4():
    ...
    stats, p_value = sct.normaltest(np.log(get_sample(athletes, 'height')))
    return(bool(p_value<=0.05))
q4()
